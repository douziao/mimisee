...
app = FastAPI(title="mimisee-magicpdf", version="0.1.0")
...
_ARTIFACT_ROOT = Path(os.environ.get("MAGIC_PDF_ARTIFACT_ROOT") or "/var/lib/mimisee/magicpdf-artifacts")
_CLI = (os.environ.get("MAGIC_PDF_CLI") or "magic-pdf").strip() or "magic-pdf"
_MODELS_DIR = (os.environ.get("MAGIC_PDF_MODELS_DIR") or "/opt/mimisee-model-cache").strip()
