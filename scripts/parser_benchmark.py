...
_STRICT_PROFILE_SCHEMA_V1 = "mimisee.parser_benchmark_strict_profile.v1"
...
def build_regression_severity_summary(
    *,
    ...
    return {
        "schema": "mimisee.parser_benchmark_regression_severity.v1",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument(
        ...
        default="",
        help=(
            "Optional strict profile JSON (schema: mimisee.parser_benchmark_strict_profile.v1). "
...
def _build_report(config: RunConfig, *, started_at: datetime) -> dict[str, Any]:
    return {
        "schema": "mimisee.parser_benchmark.v1",
