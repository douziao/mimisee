...
def coerce_case_bundle(obj: Any, *, allow_review_only: bool = False) -> tuple[str, list[dict[str, Any]]]:
    ...
    Supported shapes:
    - Export bundle v1: {"schema":"mimisee.regression_cases.v1","dataset_id":"...","items":[...]}
...
_QUERYSET_HEALTH_DIFF_SCHEMA_V1 = "mimisee.queryset_health_diff.v1"
...
def diff_queryset_health_snapshots(
    *,
    ...
    """
    Minimal diff for `mimisee.queryset_health_snapshot.v1` snapshots.
...
def build_regression_gate_report(
    *,
    ...
    return {
        "schema": "mimisee.regression_gate_report.v1",
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        default="",
        help="Baseline queryset health snapshot JSON path (optional; schema: mimisee.queryset_health_snapshot.v1)",
    )
    p.add_argument(
    ...
    p.add_argument(
        ...
        default="",
        help="Write computed queryset health diff JSON to a file (optional; schema: mimisee.queryset_health_diff.v1)",
    )
