...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Smoke-test MimiSee API endpoints.")
    ...
    parser.add_argument(
        ...
        "--jwt-email",
        dest="jwt_identifier",
        default=os.getenv("MIMISEE_SMOKE_IDENTIFIER") or os.getenv("MIMISEE_SMOKE_JWT_EMAIL") or "",
    )
    parser.add_argument(
        "--jwt-password",
        default=os.getenv("MIMISEE_SMOKE_PASSWORD") or os.getenv("MIMISEE_SMOKE_JWT_PASSWORD") or "",
    )
