...
- [OpenAPI / Redoc](https://douziao.github.io/mimisee/)
- 仓库内：[API 契约说明](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md) · [前后端排障](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md)
""".strip()
...
- [FE_BE_DEBUG.md](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md)
- [API_CONTRACT.md](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md)
""".strip(),
        "数据集 E2E",
        2,
    )
...
def ops_pages() -> None:
    ...
    md(
        "ops/deployment.md",
        "部署与 Runbook",
        "参见 [runbook.md](https://github.com/douziao/mimisee/blob/main/docs/deployment/runbook.md) 与 Docker/Helm 说明。",
        "部署",
        4,
    )
    md(
...
2. 对照 [FE_BE_DEBUG](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md) 中的 Network / 后端日志路径。
...
- 部分部署允许 `X-User-ID` / `X-Tenant-ID` 等（见后端中间件与 [API_CONTRACT](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md)）。
...
- 415 / 400：MIME 与字段名；参见 [FE_BE_DEBUG](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md)。
""".strip(),
    )
    page(
        "sse-streaming",
...
- 根目录 [`.env.example`](https://github.com/douziao/mimisee/blob/main/.env.example) 是完整环境变量模板；本地启动可复制为 `.env`，部署说明见 [docker_compose](https://github.com/douziao/mimisee/blob/main/docs/deployment/docker_compose.md)。

## 前端

- `NEXT_PUBLIC_*` 在 [web/lib/env](https://github.com/douziao/mimisee/tree/main/web/lib) 及相关构建说明中消费；修改后需重新构建。
...
- 自动化对照见 [API_CONTRACT.md](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md)。
