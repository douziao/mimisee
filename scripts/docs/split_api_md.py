...
def main() -> None:
    ...
    index_lines.append("")
    index_lines.append("- [Docusaurus 手册（GitHub Pages）](https://douziao.github.io/mimisee/handbook/)")
    index_lines.append("- [OpenAPI / Redoc](https://douziao.github.io/mimisee/)")
    index_lines.append("")
