...
MimiSee's Dify adapter with fixed cases and scores whether the expected source
...
def compare_reports(
    ...
    *,
    ...
    if candidate_gate.get("passed") is False:
        failed += 1
    return {
        "schema": "mimisee.changzhou_gov_service_knowledge.golden_compare.v1",
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Changzhou plugin golden retrieval evaluation against MimiSee.")
    parser.add_argument(
    ...
    parser.add_argument("--base-url", default=os.getenv("MIMISEE_API_BASE_URL") or "http://127.0.0.1:8000")
    parser.add_argument(
