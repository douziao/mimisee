...
export MIMISEE_DB_CREATE_ALL_ON_STARTUP="${MIMISEE_DB_CREATE_ALL_ON_STARTUP:-false}"
export MIMISEE_DB_RUNTIME_MIGRATIONS_ENABLED="${MIMISEE_DB_RUNTIME_MIGRATIONS_ENABLED:-false}"
