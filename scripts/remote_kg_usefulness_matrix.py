#!/usr/bin/env python3
"""Run a remote KG usefulness matrix against a live MimiSee API."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a remote KG usefulness matrix on a live MimiSee API.")
