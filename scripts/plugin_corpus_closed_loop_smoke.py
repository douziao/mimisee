...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--timeout", type=float, default=float(os.getenv("MIMISEE_API_TIMEOUT_SEC") or "120"))
    parser.add_argument(
        "--processing-timeout", type=float, default=float(os.getenv("MIMISEE_PROCESSING_TIMEOUT_SEC") or "1800")
    )
