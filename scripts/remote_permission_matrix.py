...
class LiveApi:
    ...
    def multipart(
        ...
        *,
        ...
        boundary = f"----MimiSeePerms{uuid.uuid4().hex}"
        chunks: list[bytes] = []
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--postgres-container", default="docker-mimisee-postgres-1")
    return parser
...
def force_member_role_via_docker(
    *,
    ...
    account_id: str,
    role: str,
    postgres_container: str = "docker-mimisee-postgres-1",
    timeout: int = 30,
) -> tuple[bool, str]:
