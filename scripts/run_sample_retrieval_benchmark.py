...
_FIXTURE_SCHEMA = "mimisee.sample_retrieval_fixture.v1"
_REPORT_SCHEMA = "mimisee.sample_retrieval_benchmark.v1"
...
def _uuid_from_seed(seed: str) -> uuid.UUID:
    return uuid.uuid5(uuid.NAMESPACE_URL, f"mimisee/sample-bench/{seed}")
