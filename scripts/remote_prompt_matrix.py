#!/usr/bin/env python3
# ruff: noqa: E402, I001
"""Run a remote prompt workflow matrix against a live MimiSee API."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a remote prompt workflow matrix on a live MimiSee API.")
