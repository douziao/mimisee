...
CASES_SCHEMA = "mimisee.changzhou_gov_eval_cases.v1"
TRUTH_SCHEMA = "mimisee.changzhou_gov_eval_truth.v1"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--dataset-id",
        default="",
        help="Existing MimiSee dataset id for live reference resolution/import.",
    )
    parser.add_argument(
        "--resume-bundle",
        default="",
