...
CASES_SCHEMA = "mimisee.mixed_rag_eval_cases.v1"
RUN_SCHEMA = "mimisee.mixed_rag_eval_run.v1"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--cases", required=True, help="Cases JSON: list or mimisee.mixed_rag_eval_cases.v1 object.")
    parser.add_argument(
        "--run",
        action="append",
        default=[],
