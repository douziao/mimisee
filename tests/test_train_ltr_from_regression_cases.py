...
def test_build_ltr_manifest_preserves_schema_and_feature_order() -> None:
    ...
    manifest = module.build_ltr_manifest(
        ...
        retrieval_config={
            "schema": "mimisee.retrieval_config.v1",
            "hash": "cfg-123",
            "top_k": 50,
        },
    ...
    assert manifest["schema"] == "mimisee.ltr_model_manifest.v1"
...
def test_main_uses_defaults_filters_cases_and_writes_artifacts(
    ...
    assert manifest["lineage"]["cases_schema"] == "mimisee.regression_cases.v1"
