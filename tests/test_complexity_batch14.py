...
def test_chunk_quality_gate_and_summary_preserve_threshold_outputs() -> None:
    ...
    assert summary == {
        "schema": "mimisee.chunk_quality_trace.v1",
...
def test_fusion_weight_services_preserve_observability_and_learning_contracts() -> None:
    ...
    rows = [
        ...
        {
            "schema": "mimisee.training_export_row.v1",
            "tenant_id": tenant_id,
    ...
    assert observability == {
        "schema": "mimisee.fusion_weight_observability.v1",
        "tenant_id": tenant_id,
        "summary": {
            "observed_rows": 2,
    ...
    assert learned["schema"] == "mimisee.tenant_fusion_weights.v1"
