...
def _valid_manifest(*, version: int = 1, model_sha256: str = "a" * 64) -> dict[str, object]:
    ...
    return {
        "schema": "mimisee.ltr_model_manifest.v1",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "manifest feature_schema must be mimisee.ltr_features.v1, .v2, or .v3",
            id="missing-feature-schema",
        ),
        pytest.param(
            lambda manifest: manifest.__setitem__("feature_schema", "mimisee.ltr_features.v9"),
            "manifest feature_schema must be mimisee.ltr_features.v1, .v2, or .v3",
    ...
    manifest.update(
        {
            ...
            "lineage": {
                "schema": "mimisee.ltr_run_lineage.v1",
                "kind": "  train  " + ("k" * 20),
                "dataset_id": "  ds-123  ",
                "cases_sha256": "  " + ("e" * 80) + "  ",
                "cases_schema": "  mimisee.regression_cases.v1  ",
    ...
    manifest.update(
        {
            ...
            "seed": None,
            "training": [],
            "lineage": {"schema": "mimisee.ltr_run_lineage.v0", "kind": "train"},
        }
    )
...
def test_register_model_persists_sanitized_manifest_and_consistent_meta(tmp_path, monkeypatch) -> None:
    ...
    expected_meta = {
        "schema": "mimisee.ltr_model_registry_meta.v1",
