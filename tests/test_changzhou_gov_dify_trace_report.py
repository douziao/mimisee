...
def test_collect_trace_report_counts_mimisee_http_conversion_code_results() -> None:
    mod = _load_module()
                            ...
                            "result": [
                                {
                                    ...
                                    "metadata": {"retriever_from": "mimisee_http"},
                                }
                            ]
                        },
                    },
                    {
                        "title": "安全构造 MimiSee 检索请求 - 新北区政务服务",
                        "node_type": "code",
