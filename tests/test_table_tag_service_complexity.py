...
def test_plan_join_query_prefers_multi_candidate_and_preserves_planner_diagnostics(
    ...
    assert result["planner"]["join_plan_risk"]["schema"] == "mimisee.tag_join_plan_risk.v1"
    assert result["planner"]["dry_run_cardinality"]["schema"] == "mimisee.tag_join_cardinality_dryrun.v1"
