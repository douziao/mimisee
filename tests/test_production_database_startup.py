...
def _set_valid_production_env(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.delenv("MIMISEE_DB_CREATE_ALL_ON_STARTUP", raising=False)
    monkeypatch.delenv("DB_CREATE_ALL_ON_STARTUP", raising=False)
    monkeypatch.delenv("MIMISEE_DB_RUNTIME_MIGRATIONS_ENABLED", raising=False)
...
@pytest.mark.parametrize(
    "field_name",
    ["MIMISEE_DB_CREATE_ALL_ON_STARTUP", "MIMISEE_DB_RUNTIME_MIGRATIONS_ENABLED"],
)
