...
- `deploy/helm/mimisee/templates/cronjob-db-maintenance.yaml`
- `deploy/helm/mimisee/templates/cronjob-semantic-cache-retention.yaml`

values 配置入口：

- `deploy/helm/mimisee/values.yaml` → `cronjobs.dbMaintenance`
- `deploy/helm/mimisee/values.yaml` → `cronjobs.semanticCacheRetention`
