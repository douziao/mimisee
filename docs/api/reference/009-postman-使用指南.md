...
> **联调视角**：建议按手册 [首日上线](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/go-live-tenant) 顺序准备环境变量与 token（亦可从 [集成总览](https://douziao.github.io/mimisee/handbook/docs/integration/welcome) 进入）。
