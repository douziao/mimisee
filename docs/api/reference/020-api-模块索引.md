...
> **联调视角**：模块与联调顺序的对照见 [集成总览](https://douziao.github.io/mimisee/handbook/docs/integration/welcome) → [首日上线](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/go-live-tenant) / [可对用户问答](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/knowledge-base-qa) / [文档卡住](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/document-stuck)。
