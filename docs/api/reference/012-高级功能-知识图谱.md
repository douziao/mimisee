...
> **联调视角**：KG 与「可检索、可问答」链路相关，验收可对照 [可对用户问答](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/knowledge-base-qa)；解析/索引异常见 [文档卡住](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/document-stuck)。
