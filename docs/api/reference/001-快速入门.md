...
> **联调视角**：本文配合「契约细节」阅读；按结果上手请见手册 [集成总览](https://douziao.github.io/mimisee/handbook/docs/integration/welcome) → [首日上线](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/go-live-tenant) / [可对用户问答](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/knowledge-base-qa)。
