...
| 文件 | 标题 |
| --- | --- |
| [`000-title.md`](./000-title.md) | MimiSee API 接口文档 |
...
- [Docusaurus 手册（GitHub Pages）](https://douziao.github.io/mimisee/handbook/)
- [OpenAPI / Redoc](https://douziao.github.io/mimisee/)

### 联调与业务剧本

- [集成总览](https://douziao.github.io/mimisee/handbook/docs/integration/welcome)
- [业务剧本：新租户首日上线](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/go-live-tenant)
- [业务剧本：知识库可对用户问答](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/knowledge-base-qa)
- [业务剧本：文档卡在解析或索引](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/document-stuck)
