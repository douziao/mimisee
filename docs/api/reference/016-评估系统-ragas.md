...
> **联调视角**：评估与回归可与「可对用户问答」验收对齐；见手册 [可对用户问答](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/knowledge-base-qa)（[集成总览](https://douziao.github.io/mimisee/handbook/docs/integration/welcome)）。

## 什么是 RAGAS？

MimiSee 评测体系支持 **37 个指标**：10 个 LLM 评判类（RAGAS）+ 27 个确定性类（无需 LLM、可复现）。
