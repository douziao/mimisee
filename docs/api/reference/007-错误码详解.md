...
> **联调视角**：4xx/5xx 与鉴权、ACL、限流对照时，可结合手册 [首日上线](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/go-live-tenant)、[文档卡住](https://douziao.github.io/mimisee/handbook/docs/integration/tasks/document-stuck) 与 [集成总览](https://douziao.github.io/mimisee/handbook/docs/integration/welcome)。
