...
MimiSee also supports an optional **hierarchy-aware recall overlay** that runs **after** the base retrieval lists are produced (channel fusion, and query-variant fusion if multi-query is enabled).
