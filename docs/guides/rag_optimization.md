...
This guide summarizes the most impactful knobs for improving retrieval quality and answer grounding in MimiSee.
...
MimiSee supports an additional **sparse** candidate source (SPLADE-style scaffolding) that can improve recall on:
...
MimiSee includes RAGAS evaluation and regression helpers. See:
