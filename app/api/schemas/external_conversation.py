...
class ExternalConversationIngestRequest(BaseModel):
    """Import conversation turns from any external chat system into MimiSee history."""
    ...
    conversation_id: UUID | None = Field(default=None, description="Append to an existing MimiSee conversation")
