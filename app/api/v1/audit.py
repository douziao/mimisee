...
_ACCESS_GRAPH_RECORD_SCHEMA = "mimisee.access_graph_export_record.v1"
_ACCESS_GRAPH_PAGE_SCHEMA = "mimisee.access_graph_export_page.v1"
_ACCESS_GRAPH_KINDS = [
    "group",
    "group_member",
    "dataset",
...
def access_graph_summary(
    *,
    ...
    payload = {
        "schema": "mimisee.access_graph_summary.v1",
