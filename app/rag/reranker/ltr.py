...
_FEATURE_SPEC_FINGERPRINT_SCHEMA_V1 = "mimisee.ltr_feature_spec.v1"
...
class LTRFeatureSpec:
    ...
    def v1() -> "LTRFeatureSpec":
        ...
        return LTRFeatureSpec(
            schema="mimisee.ltr_features.v1",
            feature_names=(
                "vector_score",
                "bm25_score",
                "lexical_score",
    ...
    def v2() -> "LTRFeatureSpec":
        ...
        return LTRFeatureSpec(schema="mimisee.ltr_features.v2", feature_names=tuple(base))
    ...
    def v3() -> "LTRFeatureSpec":
        ...
        return LTRFeatureSpec(schema="mimisee.ltr_features.v3", feature_names=tuple(base))
