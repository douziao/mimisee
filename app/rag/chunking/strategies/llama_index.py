...
class LlamaIndexChunker(BaseChunker):
    ...
    def __init__(self, chunk_size: int, chunk_overlap: int):
        ...
        # MimiSee uses character-based chunk_size/chunk_overlap across strategies.
        ...
        self.splitter = SentenceSplitter(
            ...
            # Avoid metadata consuming the token budget (MimiSee injects metadata separately).
    ...
    def split_documents(self, documents: list[Document]) -> list[Document]:
        ...
        for doc in documents:
            ...
            # even when include_metadata=False. MimiSee stores parser/provenance
