...
PLUGIN_TEST_REPORT_FILENAME = ".mimisee-plugin-test.json"
...
def _validate_processing_templates(
    ...
    *,
    ...
    return {
        "schema": "mimisee.pipeline_plugin_processing_templates.v1",
        "plugin_id": plugin_id,
        "version": version,
...
def _requires_golden_report(*, golden_rules: dict[str, Any], entries: dict[str, PipelinePluginEntry]) -> bool:
    return golden_rules.get("schema") == "mimisee.golden_rules.v1" and "chunk" in entries
...
def describe_plugin_dir(plugin_dir: Path, *, require_test_report: bool | None = None) -> PipelinePluginDescriptor:
    ...
    if "metadata_schema" in contract_paths:
        _validate_declared_contract_schema(
            ...
            expected_schema="mimisee.metadata_schema.v1",
    ...
    if "retrieval_text_schema" in contract_paths:
        _validate_declared_contract_schema(
            ...
            expected_schema="mimisee.retrieval_text_schema.v1",
    ...
    if "golden_rules" in contract_paths:
        _validate_declared_contract_schema(
            ...
            expected_schema="mimisee.golden_rules.v1",
    ...
    if "retrieval_policy" in contract_paths:
        _validate_declared_contract_schema(
            ...
            expected_schema="mimisee.retrieval_policy.v1",
    ...
    if "processing_templates" in contract_paths:
        _validate_declared_contract_schema(
            ...
            expected_schema="mimisee.pipeline_plugin_processing_templates.v1",
...
def _load_file_entry_callable(plugin_dir: Path, entry: PipelinePluginEntry) -> Any:
    ...
    with _PLUGIN_IMPORT_LOCK:
        ...
        module_name = f"_mimisee_pipeline_plugin_{module_seed}"
