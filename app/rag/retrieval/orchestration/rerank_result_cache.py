...
def build_evidence_post_rerank_cache_key(
    *,
    ...
    schema: str = "mimisee.evidence_post_rerank_cache.v1",
) -> str:
    provider_norm = _normalize_provider(provider)
    sig = {
        "schema": str(schema or "").strip() or "mimisee.evidence_post_rerank_cache.v1",
...
def set_cached_evidence_post_rerank_result(key: str, result: RerankResult) -> bool:
    ...
    payload: dict[str, Any] = {
        ...
        "schema": "mimisee.rerank_result_cache_item.v1",
    }
