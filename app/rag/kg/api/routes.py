...
def import_manual_kg(
    ...
    *,
    ...
    """
    Import a manually governed KG payload into MimiSee.

    Domain-specific extraction/rule building should happen outside MimiSee and
...
def _kg_graph_export_content(
    *, payload: str, flags: KGGraphExportFlags, tenant_id: UUID
    ...
    if flags.download:
        ...
        headers["Content-Disposition"] = f'attachment; filename="mimisee-kg-{tenant_id}.{ext}"'
