...
def _should_disable_repo_env_file() -> bool:
    ...
    if os.getenv("MIMISEE_OPENAPI_EXPORT") == "1":
        return True
...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql://postgres:postgres@localhost:5432/mimisee"
    DB_POOL_SIZE: int = 10
    ...
    DB_CREATE_ALL_ON_STARTUP: bool = Field(
        default=True,
        validation_alias=AliasChoices("MIMISEE_DB_CREATE_ALL_ON_STARTUP", "DB_CREATE_ALL_ON_STARTUP"),
    )
    DB_RUNTIME_MIGRATIONS_ENABLED: bool = Field(
        default=True,
        validation_alias=AliasChoices("MIMISEE_DB_RUNTIME_MIGRATIONS_ENABLED", "DB_RUNTIME_MIGRATIONS_ENABLED"),
    )
    ...
    #
    # Dify calls MimiSee for retrieval only. By default `knowledge_id` must be
    ...
    VISION_LLM_ENABLED: bool = Field(
        default=False,
        validation_alias=AliasChoices("MIMISEE_VISION_LLM_ENABLED", "VISION_LLM_ENABLED"),
    )
    ...
    VISION_LLM_API_KEY: str = Field(
        default="",
        validation_alias=AliasChoices("MIMISEE_VISION_LLM_API_KEY", "VISION_LLM_API_KEY"),
    )
    VISION_LLM_API_BASE: str = Field(
        default="",
        validation_alias=AliasChoices("MIMISEE_VISION_LLM_API_BASE", "VISION_LLM_API_BASE"),
    )
    # OpenAI-compatible vision model id, e.g. "gpt-5.4-mini".
    VISION_LLM_MODEL: str = Field(
        default="gpt-5.4-mini",
        validation_alias=AliasChoices("MIMISEE_VISION_LLM_MODEL", "VISION_LLM_MODEL"),
    )
    VISION_LLM_TIMEOUT_SEC: int = Field(
        default=120,
        validation_alias=AliasChoices("MIMISEE_VISION_LLM_TIMEOUT_SEC", "VISION_LLM_TIMEOUT_SEC"),
    )
    VISION_LLM_MAX_TOKENS: int = Field(
        default=4096,
        validation_alias=AliasChoices("MIMISEE_VISION_LLM_MAX_TOKENS", "VISION_LLM_MAX_TOKENS"),
    )
    VISION_LLM_TEMPERATURE: float = Field(
        default=0.0,
        validation_alias=AliasChoices("MIMISEE_VISION_LLM_TEMPERATURE", "VISION_LLM_TEMPERATURE"),
    )
    ...
    VISION_RAG_READER_ENABLED: bool = Field(
        default=False,
        validation_alias=AliasChoices("MIMISEE_VISION_RAG_READER_ENABLED", "VISION_RAG_READER_ENABLED"),
    )
    VISION_RAG_READER_MAX_IMAGES: int = Field(
        default=2,
        validation_alias=AliasChoices("MIMISEE_VISION_RAG_READER_MAX_IMAGES", "VISION_RAG_READER_MAX_IMAGES"),
    )
    VISION_RAG_READER_MAX_IMAGE_BYTES: int = Field(
        default=3_000_000,
        validation_alias=AliasChoices("MIMISEE_VISION_RAG_READER_MAX_IMAGE_BYTES", "VISION_RAG_READER_MAX_IMAGE_BYTES"),
    )
    VISION_RAG_READER_MAX_OUTPUT_CHARS: int = Field(
        default=1500,
        validation_alias=AliasChoices(
            "MIMISEE_VISION_RAG_READER_MAX_OUTPUT_CHARS", "VISION_RAG_READER_MAX_OUTPUT_CHARS"
        ),
    )
    ...
    VISION_RAG_GENERATION_ENABLED: bool = Field(
        default=False,
        validation_alias=AliasChoices("MIMISEE_VISION_RAG_GENERATION_ENABLED", "VISION_RAG_GENERATION_ENABLED"),
    )
    VISION_RAG_GENERATION_MAX_IMAGES: int = Field(
        default=2,
        validation_alias=AliasChoices("MIMISEE_VISION_RAG_GENERATION_MAX_IMAGES", "VISION_RAG_GENERATION_MAX_IMAGES"),
    )
    VISION_RAG_GENERATION_MAX_IMAGE_BYTES: int = Field(
        default=3_000_000,
        validation_alias=AliasChoices(
            "MIMISEE_VISION_RAG_GENERATION_MAX_IMAGE_BYTES",
    ...
    # excluded from the MimiSee API/worker runtime.
