...
MAGIC_PDF_MODEL_ROOT_CANDIDATES = (
    "/opt/mimisee-model-cache/huggingface/hub/models--opendatalab--PDF-Extract-Kit-1.0/snapshots",
    "/opt/mimisee-model-cache/huggingface/models--opendatalab--PDF-Extract-Kit-1.0/snapshots",
...
MAGIC_PDF_SERVICE_HOSTNAMES = {"mimisee-magicpdf"}
