...
def _is_mimisee_citation(value: Any) -> bool:
    return _normalize_mimisee_citation(value) is not None
...
def _normalize_mimisee_citation(value: Any) -> dict[str, Any] | None:
...
def _mimisee_citations_for_storage(citations: list[dict[str, Any]]) -> list[dict[str, Any]]:
    out: list[dict[str, Any]] = []
    seen: set[tuple[str, str]] = set()
    for item in citations:
        normalized = _normalize_mimisee_citation(item)
...
def ingest_external_conversation(
    *,
    ...
    for incoming in request.messages:
        ...
        stored_citations = _mimisee_citations_for_storage(citation_candidates)
