...
def build_dataset_scope_corpus_cache_token(
    *, dataset_id: Any, updated_at: Any, dataset_embedding_binding: Any = None
    ...
    if not ds:
        return None
    sig = {
        "schema": "mimisee.dataset_corpus_cache_token.v1",
        "dataset_id": ds,
...
def build_document_scope_corpus_cache_token(rows: Sequence[Any]) -> str | None:
    ...
    raw = json.dumps(
        {
            "schema": "mimisee.document_scope_corpus_cache_token.v1",
            "documents": items,
        },
        sort_keys=True,
        separators=(",", ":"),
...
def build_multi_dataset_scope_corpus_cache_token(rows: Sequence[Any]) -> str | None:
    ...
    raw = json.dumps(
        {
            "schema": "mimisee.multi_dataset_scope_corpus_cache_token.v1",
            "datasets": items,
        },
        sort_keys=True,
        separators=(",", ":"),
