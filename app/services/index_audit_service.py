...
def build_index_drift_marker(
    *,
    ...
    payload: dict[str, Any] = {
        "schema": "mimisee.index_drift_marker.v1",
...
def replay_index_drift_items(
    *,
    ...
    return {
        "schema": "mimisee.index_drift_replay.v1",
...
def _build_index_audit_reconcile_document_status_payload(
    *,
    ...
    return {
        "schema": "mimisee.index_audit_reconcile_status.v1",
        "tenant_id": str(tenant_id),
        "dataset_id": str(dataset_id),
...
def plan_index_audit_reconcile(
    *,
    ...
    return {
        "schema": "mimisee.index_audit_reconcile_plan.v1",
        "tenant_id": str(tenant_id),
        "dataset_id": str(dataset_id),
        "document_id": str(document_id) if document_id is not None else None,
...
async def enqueue_index_audit_reconcile(
    *,
    ...
    if document_id is None:
        return {
            "schema": "mimisee.index_audit_reconcile.v1",
            "tenant_id": str(tenant_id),
            "dataset_id": str(dataset_id),
            "document_id": None,
            "scope": "dataset",
