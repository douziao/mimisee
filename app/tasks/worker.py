...
_WORKER_HEARTBEAT_TASK_KEY = "_mimisee_worker_heartbeat_task"
...
async def startup(ctx):  # noqa: ANN001
    ...
    try:
        ...
        queue_name = str(getattr(settings, "TASK_QUEUE_NAME", "mimisee") or "mimisee")
...
class WorkerSettings:
    ...
    queue_name = getattr(settings, "TASK_QUEUE_NAME", "mimisee")
    functions = [
        func(
            process_document_job,
