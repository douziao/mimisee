...
TASK_JOB_RESULT_SCHEMA_V1 = "mimisee.task_job_result.v1"
...
async def _record_job_outcome(ctx, payload: dict[str, Any]) -> None:  # noqa: ANN001
    ...
    try:
        ...
        await observe_task_job_outcome(
            redis=redis,
            queue_name=str(getattr(settings, "TASK_QUEUE_NAME", "") or "mimisee"),
            outcome=payload,
        )
    except Exception:  # noqa: BLE001
        return
...
async def reconcile_index_audit_job(
    ...
    try:
        ...
        return await _reconcile_index_audit_job_result(
            ...
            report={
                "schema": str(plan.get("schema") or "mimisee.index_audit_reconcile_plan.v1"),
