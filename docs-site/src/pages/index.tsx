...
function getCopy(locale: string) {
  ...
  return {
    eyebrow: en ? 'MIMISEE DOCUMENTATION' : 'MIMISEE 全栈手册',
    title: en
    ...
    paths: en
      ? [
          {icon: 'terminal' as const, label: 'First deployment', title: 'From .env to first login', description: 'Prepare credentials, choose Docker or host processes, and verify readiness.', to: '/docs/ops/getting-started', action: 'Deploy MimiSee'},
      ...
      : [
          {icon: 'terminal' as const, label: '首次部署', title: '从 .env 到首次登录', description: '准备密钥，选择 Docker 或主机进程，完成健康检查。', to: '/docs/ops/getting-started', action: '部署 MimiSee'},
  ...
  return (
    <section className={styles.closing}>
      ...
      <div className={styles.closingActions}>
        <a href="https://douziao.github.io/mimisee/">
          {copy.api}
          <Icon name="arrow" size={16} />
        </a>
        <a href="https://github.com/douziao/mimisee">
