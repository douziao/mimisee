...
DB Catalog 是 MimiSee 的结构化数据连接能力的基础：通过 Connector 连接外部数据库，自动发现 schema/table/column 元数据并存入目录，供后续的 Text-to-SQL 和 TAG 查询使用。
...
- [概述](./overview.md)
- [Redoc API 文档](https://douziao.github.io/mimisee/)
