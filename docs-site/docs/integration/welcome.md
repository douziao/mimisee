...
本分区从 **「如何把 MimiSee 接进你的环境」** 出发，与 Frontend / Backend / Ops 文档互补：那边讲页面与实现细节，这里讲 **业务结果、推荐路径与契约入口**。
...
- **人机可读契约**：[API_CONTRACT](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md) | [前后端排障](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md)
- **全量 Schema / 试调用**：[OpenAPI / Redoc](https://douziao.github.io/mimisee/)
...
| 场景化 API 顺序 | [workflows.md](https://github.com/douziao/mimisee/blob/main/docs/api/workflows.md) |
| 契约与排障 | [API_CONTRACT](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md) | [FE_BE_DEBUG](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md) |
