...
:::info
Token 格式与刷新策略以 [Redoc auth 分组](https://douziao.github.io/mimisee/) 为准。开发环境可能支持 Header 调试模式，但**生产环境必须使用正式认证**。
:::
...
| 422 | 请求体字段不匹配 | 对照 [Redoc](https://douziao.github.io/mimisee/) 必填字段 |
