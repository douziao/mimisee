# MimiSee 全栈手册（Docusaurus）

本目录为 [MimiSee](https://github.com/douziao/mimisee) 的 **docs-site**：与 `docs/api/site` 的 Redoc **并存**，部署在 GitHub Pages 的 **`/MimiSee/handbook/`** 路径下。
...
浏览器访问：`http://localhost:3000/MimiSee/handbook/`（与 `docusaurus.config.ts` 中 `baseUrl` 一致）。
