...
This section starts from **"How to integrate MimiSee into your environment"** and complements the Frontend / Backend / Ops documentation: those cover pages and implementation details, while this section focuses on **business outcomes, recommended paths, and contract entry points**.
...
- **Human & machine-readable contracts**: [API_CONTRACT](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md) | [FE/BE Debugging](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md)
- **Full Schema / try calls**: [OpenAPI / Redoc](https://douziao.github.io/mimisee/)
...
MimiSee supports three authentication methods, in order of priority:
...
| Type | Link |
| --- | --- |
| Redoc | [douziao.github.io/mimisee](https://douziao.github.io/mimisee/) |
| Scenario-based API Sequences | [workflows.md](https://github.com/douziao/mimisee/blob/main/docs/api/workflows.md) |
| Contracts & Debugging | [API_CONTRACT](https://github.com/douziao/mimisee/blob/main/docs/integration/API_CONTRACT.md) | [FE_BE_DEBUG](https://github.com/douziao/mimisee/blob/main/docs/integration/FE_BE_DEBUG.md) |
