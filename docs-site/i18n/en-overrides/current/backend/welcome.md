...
This handbook is for **backend developers, architects, and integration engineers**, helping you quickly understand MimiSee backend's module boundaries, API contracts, and internal flows. Use [OpenAPI / Redoc](https://douziao.github.io/mimisee/) as the authoritative Schema reference; this handbook focuses on **navigation indexes, state-machine descriptions, and troubleshooting guides**.
