...
This handbook is for **frontend developers and full-stack engineers**, helping you understand MimiSee Web's routing structure, component system, and API call layer. Types and paths use [OpenAPI / Redoc](https://douziao.github.io/mimisee/) as the authoritative reference; frontend routes follow `web/app/**/page.tsx`.
