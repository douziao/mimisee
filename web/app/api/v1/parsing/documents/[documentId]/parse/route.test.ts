...
describe('long-running parsing proxy route', () => {
  it('forwards auth headers and query parameters to the internal backend', async () => {
    vi.stubEnv('API_INTERNAL_URL', 'http://mimisee-api:8000/')
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      new URL(
        'http://mimisee-api:8000/api/v1/parsing/documents/doc-1/parse?parser_backend=deepdoc&image_ocr_enabled=true',
      ),
