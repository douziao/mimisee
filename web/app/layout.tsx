...
export const metadata: Metadata = {
  title: "MimiSee - 可检查、可回归的 RAG 知识库",
  description: "可观察、可替换、可回归的企业 RAG 基础设施",
  manifest: "/manifest.webmanifest",
  icons: {
    icon: [
      { url: MIMISEE_MARK_PATH, sizes: "512x512", type: "image/png", media: "(prefers-color-scheme: light)" },
      { url: MIMISEE_MARK_PATH, sizes: "512x512", type: "image/png", media: "(prefers-color-scheme: dark)" },
    ],
    apple: [{ url: MIMISEE_MARK_PATH, sizes: "512x512", type: "image/png" }],
  },
}
