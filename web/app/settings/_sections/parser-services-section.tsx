      ...
      <section>
        ...
        <div className={CARD}>
          <div className="rounded-[14px] border border-info/20 bg-info/[0.07] px-3 py-2.5">
            ...
            <div className={cn(FIELD_HINT, 'mt-0.5')}>
              Docling 依赖与模型只运行在独立容器中，不会增加 MimiSee API / worker 镜像体积
            </div>
          </div>
          ...
          <div className={GRID}>
            <div className="space-y-2 lg:col-span-2">
              ...
              <Input
                ...
                placeholder="http://mimisee-docling:5001"
              />
          ...
          <div className={GRID}>
            ...
            <div className="space-y-2 lg:col-span-2">
              ...
              <Input
                ...
                placeholder="/opt/mimisee-model-cache/.../PDF-Extract-Kit-1.0/.../models"
              />
              <div className={FIELD_HINT}>
