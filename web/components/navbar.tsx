...
const OPEN_SECTIONS_STORAGE_KEY = 'mimisee_navbar_open_sections_v2'
...
export function Navbar({
  ...
  useEffect(() => {
    ...
    const key = '__mimisee_routes_prefetched__'
      ...
      >
        ...
        <div className="h-14 px-5 border-b border-info/12 bg-sidebar/96 flex items-center gap-3">
          <Link href="/" className="flex items-center gap-3 group rounded-xl focus-ring">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-sidebar-foreground leading-none">MimiSee</span>
        ...
        <div className="px-3 pb-2">
          <button
            ...
            aria-controls="mimisee-command-menu"
