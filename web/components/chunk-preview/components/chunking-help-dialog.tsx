            ...
            <section className="rounded-xl border border-border/60 bg-card/60 p-4">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <Button asChild variant="outline" size="sm" className="h-8 px-3 text-[11px]">
                  <a
                    href="https://github.com/douziao/mimisee/blob/main/docs/guides/chunk_preview.md"
                    target="_blank"
                ...
                <Button asChild variant="outline" size="sm" className="h-8 px-3 text-[11px]">
                  <a
                    href="https://github.com/douziao/mimisee/blob/main/docs/guides/chunk_strategies.md"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
