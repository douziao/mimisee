...
const PAGE_ALL_VALUE = '__mimisee_page_all__'
const PAGE_UNKNOWN_VALUE = '__mimisee_page_unknown__'
const SECTION_ALL_VALUE = '__mimisee_section_all__'
const SECTION_NONE_VALUE = '__mimisee_section_none__'
