...
export function OriginalPreviewMonaco(props: Readonly<{
  ...
  const applyActiveDecorations = useCallback(() => {
    ...
    if (parent) {
      ...
      if (parentEnd > parentStart) {
        ...
        decos.push({
          ...
          options: {
            inlineClassName: 'mimisee-monaco-parent-highlight',
          },
        })
      }
    }
    ...
    if (chunk && activeEnd > activeStart) {
      ...
      decos.push({
        range: chunkRange,
        options: {
          inlineClassName: 'mimisee-monaco-active-highlight',
        },
      })
    ...
    if (explicit && explicit.end > explicit.start) {
      ...
      decos.push({
        range: explicitRange,
        options: {
          inlineClassName: 'mimisee-monaco-citation-highlight',
        },
      })
  ...
  return (
    <div className="relative h-full min-h-[520px] rounded-xl border border-border/60 overflow-hidden bg-background">
      ...
      <style jsx global>{`
        .mimisee-monaco-parent-highlight {
          background: rgba(59, 130, 246, 0.08);
        }
        .mimisee-monaco-active-highlight {
          background: rgba(59, 130, 246, 0.18);
          border-radius: 2px;
          box-shadow: inset 0 0 0 1px rgba(59, 130, 246, 0.25);
        }
        .mimisee-monaco-citation-highlight {
