...
const STORAGE_DATASET_ID_KEY = 'mimisee_chunk_preview_dataset_id'
const STORAGE_SEPARATOR_SETTINGS_KEY = 'mimisee_chunk_preview_separator_settings'
const STORAGE_FOCUS_FILE_ID_KEY = 'mimisee_chunk_preview_focus_file_id'
const STORAGE_PERF_SETTINGS_KEY = 'mimisee_chunk_preview_perf_settings'
const STORAGE_PARENT_CHILD_SETTINGS_KEY = 'mimisee_chunk_preview_parent_child_settings'
