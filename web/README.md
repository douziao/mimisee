...
MimiSee supports IdP-initiated SAML 2.0 behind a guarded Next.js ACS route plus backend assertion exchange.
...
- On success, the backend maps `NameID`/email to an existing MimiSee user and issues a normal app JWT session.
