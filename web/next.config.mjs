...
const localDevHostnames = new Set(['localhost', '127.0.0.1', '0.0.0.0', 'web', 'mimisee-api'])
const hstsDisabled =
...
const nextConfig = {
  ...
  webpack: (config, { webpack }) => {
    config.plugins.push({
      apply: (compiler) => {
        compiler.hooks.compilation.tap('MimiSeePdfjsWorkerMinifyFix', (compilation) => {
          compilation.hooks.processAssets.tap(
            {
              name: 'MimiSeePdfjsWorkerMinifyFix',
