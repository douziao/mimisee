...
type StaleChunkRecoveryGlobal = typeof globalThis & {
  __mimiseeStaleChunkRecoveryInstalled__?: boolean
}
...
function installStaleChunkRecovery() {
  ...
  if (runtime.__mimiseeStaleChunkRecoveryInstalled__) return
  runtime.__mimiseeStaleChunkRecoveryInstalled__ = true
