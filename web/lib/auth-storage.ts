...
const ACCESS_TOKEN_KEY = 'mimisee_access_token'
const USER_KEY = 'mimisee_user_profile'
const USER_ID_KEY = 'mimisee_user_id'
const TENANT_ID_KEY = 'mimisee_tenant_id'
const TOKEN_EXPIRES_AT_KEY = 'mimisee_token_expires_at'
export const DOCUMENT_VIEW_STORAGE_KEY = 'mimisee_document_view_v1'
const TOKEN_STORAGE_KIND = 'session' as const
const LEGACY_TOKEN_STORAGE_KIND = 'local' as const
const AUTH_SYNC_STORAGE_KEY = 'mimisee_auth_sync'
const AUTH_SYNC_CHANNEL_NAME = 'mimisee:auth-sync'
const AUTH_SYNC_CLEAR_TYPE = 'session-cleared'

export const AUTH_SCOPE_CHANGED_EVENT = 'mimisee:auth-scope-changed'
