...
export const SURFACE_THEME_STORAGE_KEY = 'mimisee.surfaceTheme'
export const THEME_COLOR_STORAGE_KEY = 'mimisee.themeColor'
export const SURFACE_THEME_COOKIE_KEY = 'mimisee_surface_theme'
export const THEME_COLOR_COOKIE_KEY = 'mimisee_theme_color'
export const THEME_APPEARANCE_CHANGED_EVENT = 'mimisee:theme-appearance-changed'
