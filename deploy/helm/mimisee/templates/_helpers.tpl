...
{{- define "mimisee.fullname" -}}
{{- if .Values.fullnameOverride -}}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := include "mimisee.name" . -}}
...
{{- define "mimisee.labels" -}}
helm.sh/chart: {{ .Chart.Name }}-{{ .Chart.Version | replace "+" "_" }}
app.kubernetes.io/name: {{ include "mimisee.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{- end -}}

{{- define "mimisee.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mimisee.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "mimisee.secretName" -}}
{{- if .Values.existingSecretName -}}
{{- .Values.existingSecretName -}}
{{- else -}}
{{- printf "%s-env" (include "mimisee.fullname" .) -}}
{{- end -}}
{{- end -}}

{{- define "mimisee.serviceAccountName" -}}
{{- if .Values.serviceAccount.name -}}
{{- .Values.serviceAccount.name -}}
{{- else -}}
{{- include "mimisee.fullname" . -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "mimisee.serviceAccountNameBlock" -}}
{{- if or .Values.serviceAccount.create .Values.serviceAccount.name -}}
serviceAccountName: {{ include "mimisee.serviceAccountName" . }}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "mimisee.imagePullSecretsBlock" -}}
...
*/}}
{{- define "mimisee.podSecurityContext" -}}
{{- $root := .root -}}
{{- $extra := .extra -}}
{{- $ctx := dict -}}
...
*/}}
{{- define "mimisee.containerSecurityContext" -}}
{{- $root := .root -}}
{{- $extra := .extra -}}
{{- $ctx := dict -}}
...
*/}}
{{- define "mimisee.automountServiceAccountToken" -}}
{{- $root := .root -}}
{{- $override := .override -}}
